...
{
    public function broadcast(NextMessageSelector $nextMessageSelector): Response
    {
    ...
    public function broadcastProcessed(Request $request, ProcessedMessageRemover $processedMessageRemover): Response
    {
